    ...
    return (
        <html lang="en" className="">
            ...
            <body className="font-arimo bg-[#0F110C] pt-[64px] pb-[40px] px-[32px] lg:p-[40px] text-white w-full h-[100svh]">
                ...
                <div className="fixed w-full bg-[#0F110C] h-[4.69svh] bottom-0 left-0 z-20 lg:hidden"></div>
                    <div className="absolute w-full h-full [&>*]:fixed">
                        <button className="max-lg:hidden">About us</button>
                        <button className="top-[86px] max-lg:hidden">
                            Gallery
                        </button>
                        <button className="font-bold max-lg:top-[147px] lg:left-[18.82vw]">
                            fur coats
                        </button>
                        <button className="font-bold  max-lg:top-[147px] left-[134px] lg:left-[26.94vw] text-[#3F3F3F]">
                            Accessories
                        </button>
                        <button className="right-[34.79vw] max-lg:hidden">
                            € Eur
                        </button>
                        <button className="right-[31.18vw] max-lg:hidden">
                            Eng
                        </button>
                        ...
                        <Link href="/" className="lg:right-[40px] z-50">
                            <Logo />
                        </Link>
