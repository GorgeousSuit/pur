...
const ProductPage = () => {
    return (
        <section className="flex max-lg:items-end max-lg:justify-center h-[calc(100svh-32px)]">
            <div className="max-lg:hidden mt-[196px]">
                <ProductList />
            </div>
            <div className="flex max-lg:flex-col lg:justify-end lg:absolute lg:left-[calc(50%-305px)] lg:mt-[-40px]">
